...
class Officer extends Model
{
    ...
    public static function colorEvents(){
        return array(
            "#3a87ad7a","#ff4d4d8c","#33cc337a","#ff981a","#ff531a","#8600b3","#8080ff","#ff1a8c","#ccffcc","#4dff4d","#85adad","#660000","#ff99ff","#ffcc99","#c3c388","#3a87ad7a","#003300","#3d5c5c","#33331a","#ff8000",
            "#3a87ad7a","#3a87ad7a","#3a87ad7a","#3a87ad7a","#F0F8FF","#FAEBD7","#00FFFF","#7FFFD4","#F0FFFF","#F5F5DC","#FFE4C4","#000000","#FFEBCD","#0000FF","#8A2BE2","#A52A2A","#DEB887","#5F9EA0","#7FFF00","#D2691E",
